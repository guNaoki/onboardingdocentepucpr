    ...
    <div className="container mx-auto px-5 py-10 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
        {[
          ...
          <div key={idx} className="bg-white border border-border-color rounded-2xl p-8 text-center transition-all hover:shadow-hover hover:-translate-y-1 hover:border-puc-red group">
            ...
            <button className="bg-white text-puc-red border border-puc-red px-6 py-2 rounded-full font-semibold hover:bg-puc-red hover:text-white transition-all w-full">
              {item.action}
            </button>
          </div>
        ))}
